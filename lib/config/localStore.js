 ...
 * 本地文件 KV 存储
 *
 * 本地 JSON 文件持久化，数据落盘到 DATA_DIR
 * （由宿主应用经 ESD_DATA_DIR 注入，独立运行回退至本地 data 目录）。
 *
 */
...
export class LocalStore {
  /** 数据目录（data/<用户ID>/snowbaby，由宿主应用经 ESD_DATA_DIR 注入，独立运行回退至本地 data 目录） */
  static DATA_DIR = DATA_DIR
